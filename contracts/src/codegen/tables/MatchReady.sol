...
library MatchReady {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchReady", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d617463685265616479000000000000);
