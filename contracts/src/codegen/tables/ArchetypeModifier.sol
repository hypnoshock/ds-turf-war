...
library ArchetypeModifier {
     ...
     */
    function getAttackerArchetype(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (CombatArchetypes attackerArchetype)
    {
        bytes32[] memory _keyTuple = new bytes32[](2);
        _keyTuple[0] = bytes32(uint256(uint8(attacker)));
        _keyTuple[1] = bytes32(uint256(uint8(defender)));
     ...
     * @notice Get attackerArchetype.
     */
    function _getAttackerArchetype(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (CombatArchetypes attackerArchetype)
    {
     ...
     */
    function getDefenderArchetype(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (CombatArchetypes defenderArchetype)
    {
        bytes32[] memory _keyTuple = new bytes32[](2);
        _keyTuple[0] = bytes32(uint256(uint8(attacker)));
        _keyTuple[1] = bytes32(uint256(uint8(defender)));
     ...
     * @notice Get defenderArchetype.
     */
    function _getDefenderArchetype(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (CombatArchetypes defenderArchetype)
    {
     ...
     */
    function get(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (ArchetypeModifierData memory _table)
    {
        bytes32[] memory _keyTuple = new bytes32[](2);
        _keyTuple[0] = bytes32(uint256(uint8(attacker)));
        _keyTuple[1] = bytes32(uint256(uint8(defender)));
     ...
     * @notice Get the full data.
     */
    function _get(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        view
        returns (ArchetypeModifierData memory _table)
    {
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (int32 mod, CombatArchetypes attackerArchetype, CombatArchetypes defenderArchetype)
    {
     ...
     */
    function encodeStatic(int32 mod, CombatArchetypes attackerArchetype, CombatArchetypes defenderArchetype)
        internal
        pure
     ...
     */
    function encode(int32 mod, CombatArchetypes attackerArchetype, CombatArchetypes defenderArchetype)
        internal
        pure
     ...
     */
    function encodeKeyTuple(CombatArchetypes attacker, CombatArchetypes defender)
        internal
        pure
