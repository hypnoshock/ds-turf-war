...
library TemplateContent {
     ...
     */
    function getEncodedLengths(bytes32 templateId, ResourceId tableId)
        internal
        view
        returns (EncodedLengths encodedLengths)
    {
     ...
     * @notice Get encodedLengths.
     */
    function _getEncodedLengths(bytes32 templateId, ResourceId tableId)
        internal
        view
        returns (EncodedLengths encodedLengths)
    {
    ...
    function setEncodedLengths(bytes32 templateId, ResourceId tableId, EncodedLengths encodedLengths) internal {
        ...
        StoreSwitch.setStaticField(
            _tableId, _keyTuple, 0, abi.encodePacked(EncodedLengths.unwrap(encodedLengths)), _fieldLayout
        );
    }
     ...
     */
    function getItemStaticData(bytes32 templateId, ResourceId tableId, uint256 _index)
        internal
        view
     ...
     * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
     */
    function _getItemStaticData(bytes32 templateId, ResourceId tableId, uint256 _index)
        internal
        view
        returns (bytes memory)
    {
     ...
     * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
     */
    function getItemDynamicData(bytes32 templateId, ResourceId tableId, uint256 _index)
        internal
        view
        returns (bytes memory)
    {
     ...
     * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
     */
    function _getItemDynamicData(bytes32 templateId, ResourceId tableId, uint256 _index)
        internal
        view
        returns (bytes memory)
    {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (TemplateContentData memory _table)
    {
     ...
     */
    function encodeLengths(bytes memory staticData, bytes memory dynamicData)
        internal
        pure
     ...
     */
    function encode(EncodedLengths encodedLengths, bytes memory staticData, bytes memory dynamicData)
        internal
        pure
