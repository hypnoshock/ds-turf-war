...
library LevelPositionIndex {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "LevelPositionInd", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c6576656c506f736974696f6e496e64);
