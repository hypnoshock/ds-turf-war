...
library TemplateTables {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "TemplateTables", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000054656d706c6174655461626c65730000);
