...
library MatchMapCopyProgress {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchMapCopyProg", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d617463684d6170436f707950726f67);
