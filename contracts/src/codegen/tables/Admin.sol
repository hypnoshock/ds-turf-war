...
library Admin {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Admin", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000041646d696e0000000000000000000000);
