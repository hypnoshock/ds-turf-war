...
library MatchPlayers {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchPlayers", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d61746368506c617965727300000000);
