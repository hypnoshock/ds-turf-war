...
library MatchReward {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchReward", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d617463685265776172640000000000);
