...
library CombatOutcome {
     ...
     */
    function getAttackerDamageReceived(bytes32 matchEntity, bytes32 entity)
        internal
        view
        returns (int32 attackerDamageReceived)
    {
        bytes32[] memory _keyTuple = new bytes32[](2);
        _keyTuple[0] = matchEntity;
        _keyTuple[1] = entity;
     ...
     * @notice Get attackerDamageReceived.
     */
    function _getAttackerDamageReceived(bytes32 matchEntity, bytes32 entity)
        internal
        view
        returns (int32 attackerDamageReceived)
    {
     ...
     */
    function getDefenderDamageReceived(bytes32 matchEntity, bytes32 entity)
        internal
        view
        returns (int32 defenderDamageReceived)
    {
        bytes32[] memory _keyTuple = new bytes32[](2);
        _keyTuple[0] = matchEntity;
        _keyTuple[1] = entity;
     ...
     * @notice Get defenderDamageReceived.
     */
    function _getDefenderDamageReceived(bytes32 matchEntity, bytes32 entity)
        internal
        view
        returns (int32 defenderDamageReceived)
    {
    ...
    function decode(bytes memory _staticData, EncodedLengths, bytes memory)
        internal
        pure
        returns (CombatOutcomeData memory _table)
    {
        (
            _table.attacker,
            _table.defender,
