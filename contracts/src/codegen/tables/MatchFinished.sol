...
library MatchFinished {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchFinished", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d6174636846696e6973686564000000);
