...
library MatchSpawnPoints {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchSpawnPoints", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d61746368537061776e506f696e7473);
