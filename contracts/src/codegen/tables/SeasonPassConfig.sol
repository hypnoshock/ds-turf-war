...
library SeasonPassConfig {
     ...
     */
    function set(uint256 minPrice, uint256 startingPrice, uint256 rate, uint256 multiplier, uint256 mintCutoff)
        internal
    {
     ...
     * @notice Set the full data using individual values.
     */
    function _set(uint256 minPrice, uint256 startingPrice, uint256 rate, uint256 multiplier, uint256 mintCutoff)
        internal
    {
        bytes memory _staticData = encodeStatic(minPrice, startingPrice, rate, multiplier, mintCutoff);
    ...
    function set(SeasonPassConfigData memory _table) internal {
        bytes memory _staticData =
            encodeStatic(_table.minPrice, _table.startingPrice, _table.rate, _table.multiplier, _table.mintCutoff);
    ...
    function decode(bytes memory _staticData, EncodedLengths, bytes memory)
        internal
        pure
        returns (SeasonPassConfigData memory _table)
    {
        (_table.minPrice, _table.startingPrice, _table.rate, _table.multiplier, _table.mintCutoff) =
     ...
     */
    function encodeStatic(uint256 minPrice, uint256 startingPrice, uint256 rate, uint256 multiplier, uint256 mintCutoff)
        internal
        pure
     ...
     */
    function encode(uint256 minPrice, uint256 startingPrice, uint256 rate, uint256 multiplier, uint256 mintCutoff)
        internal
        pure
