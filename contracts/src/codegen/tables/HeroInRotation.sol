...
library HeroInRotation {
    // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "HeroInRotation", typeId: RESOURCE_TABLE });`
    ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004865726f496e526f746174696f6e0000);
